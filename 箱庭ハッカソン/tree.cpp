...
HRESULT InitTree(void)
{
	...
	// 木の設定
	//SetTree(XMFLOAT3(0.0f, 0.0f, 0.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 0.6f, 0.8f, 1.0f));
	//SetTree(XMFLOAT3(20.0f, 0.0f, 40.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	//SetTree(XMFLOAT3(-30.0f, 0.0f, 20.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	//SetTree(XMFLOAT3(50.0f, 0.0f, 30.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	//SetTree(XMFLOAT3(-40.0f, 0.0f, 10.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
...
int SetTree(XMFLOAT3 pos, float fWidth, float fHeight, XMFLOAT4 col)
{
	...
	for(int nCntTree = 0; nCntTree < MAX_TREE; nCntTree++)
	{
		if(!g_aTree[nCntTree].bUse)
		{
			...
			g_aTree[nCntTree].scl = XMFLOAT3(1.0f, 1.0f, 1.0f);
			g_aTree[nCntTree].material.Diffuse = col;
